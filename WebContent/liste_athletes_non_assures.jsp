...
<body>
	<h2 style="color:white;background-color:#6683b1;text-align:center">Liste des athlètes non assurés</h2>
	<table border="1" >
		<tr>								<!-- ligne1 -->
			<th> Identifiant </th>			<!-- case 1 -->
			<th> Nom </th>					<!-- case 2 -->
			<th> Prénom </th>				<!-- case 3 -->
			<th> Date de naissace </th>		<!-- case 4 -->
			<th> Depuis </th>				<!-- case 5 -->
			<th> Jusqu'au </th>				<!-- case 6 -->
		</tr>
<%
...
%>
		<tr>																		<!-- ligne i -->
			<th> <a href = <%=link_athlete_assurance%>><%=myAthlete.ID%></a> </th>	<!-- case 1 -->
			<th> <%=myAthlete.NOM%> </th>											<!-- case 2 -->
			<th> <%=myAthlete.PRENOM%> </th>										<!-- case 3 -->
			<th> <%=myAthlete.DATE_NAIS%> </th>										<!-- case 4 -->
			<th> <%=debut%> </th>													<!-- case 5 -->
			<th> <%=fin%> </th>														<!-- case 6 -->
		</tr>
<%
