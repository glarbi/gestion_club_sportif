			...
			<div class="container">
				<div id="content">
					...
					<%
						...
						if (t1 == null)
							t1 = DBManager.getFreeAthleteID().toString();
					...
					<form name="athleteForm" method="get"
						...
						<p align="center">
						<h2>Informations de l'athlète</h2>
						</p>
						<table>
							<tr>
								<th>
								...
								<th>
									<p>
										<input type="text" name="ID" style="color: graytext"
											value="<%=myAthlete.ID%>" size=25 align="right" />
									</p>
								</th>
							</tr>
							<tr>
								...
								<th>
									<p>
										<input type="text" name="Nom" style="color: graytext"
											value="<%=myAthlete.NOM%>" size=25 align="right" />
									</p>
								</th>
							</tr>
							<tr>
								...
								<th>
									<p>
										<input type="text" name="Prenom" style="color: graytext"
											value="<%=myAthlete.PRENOM%>" size=25 align="right" />
									</p>
								</th>
							</tr>
							<tr>
								...
								<th>
									<p>
										<input type="text" name="LieuNais" style="color: graytext"
											value="<%=myAthlete.LIEU_NAIS%>" size=25 align="right" />
									</p>
								</th>
							</tr>
							<tr>
								...
								<th>
									<p>
										<input type="text" name="PrenomPere" style="color: graytext"
											value="<%=myAthlete.prenomPere%>" size=25 align="right" />
									</p>
								</th>
							</tr>
							<tr>
								...
								<th>
									<p>
										<input type="text" name="ProfPere" style="color: graytext"
											value="<%=myAthlete.profPere%>" size=25 align="right" />
									</p>
								</th>
							</tr>
							<tr>
								...
								<th>
									<p>
										<input type="text" name="NomMere" style="color: graytext"
											value="<%=myAthlete.nomMere%>" size=25 align="right" />
									</p>
								</th>
							</tr>
							<tr>
								...
								<th>
									<p>
										<input type="text" name="PrenomMere" style="color: graytext"
											value="<%=myAthlete.prenomMere%>" size=25 align="right" />
									</p>
								</th>
							</tr>
							<tr>
								...
								<th>
									<p>
										<input type="text" name="ProfMere" style="color: graytext"
											value="<%=myAthlete.profMere%>" size=25 align="right" />
									</p>
								</th>
							</tr>
							<tr>
								...
								<th>
									<p>
										<input type="text" name="Adresse" style="color: graytext"
											value="<%=myAthlete.ADRESSE%>" size=25 align="right" />
									</p>
								</th>
							</tr>
							<tr>
								...
								<th>
									<p>
										<input type="text" name="Tel" style="color: graytext"
											value="<%=myAthlete.NUM_TEL%>" size=25 align="right" />
									</p>
								</th>
							</tr>
							<tr>
					...
					%>
					<a href="athlete.jsp?ID=<%=Integer.parseInt(myAthlete.ID) + 1%>">Suivant
						--></a><br />
					<%
						}
					%>
